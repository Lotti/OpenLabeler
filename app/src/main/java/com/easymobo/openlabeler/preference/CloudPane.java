...
public class CloudPane extends VBox implements Category
{
    @FXML
    ...
    private static final Logger LOG = Logger.getLogger(CloudPane.class.getCanonicalName());
    ...
    public CloudPane(String name, ResourceBundle bundle) {
